...
#             raise CustomException(e,sys)
    # def initiate_data_transformation(self,train_path,test_path):
        ...
        #     logging.info("applying preprocessing object on training and testing datafranme")
        #     print("COLUMNS IN TRAIN DF:", train_df.columns.tolist())
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            # Feature lists (AFTER normalization)
            numerical_columns = ['writing_score', 'reading_score']
            categorical_columns = [
                'gender',
                'race_ethnicity',
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Train and test CSV loaded")
            ...
            # TARGET RESHAPE
            # -------------------------
            y_train = np.array(target_feature_train_df).reshape(-1, 1)
            y_test = np.array(target_feature_test_df).reshape(-1, 1)
